...
public final class DoflamingoMomentumV5SwingStrategyProvider implements StrategyProvider {
    ...
    private static final StrategyParameterSchema SCHEMA = new StrategyParameterSchema(commonDefinitions(List.of(
            ...
            bool("allowShorts", "Allow Shorts", "Allow swing short entries. NSE cash shorts are disabled by default for this swing profile.", false),
            enumeration("contextCloudBiasMode", "Context Cloud Bias Mode", "Mapped higher-timeframe cloud-bias handling for swing entries.", "PREFER_AGREEMENT", List.of("OFF", "PREFER_AGREEMENT", "REQUIRE_AGREEMENT")),
            ...
            decimal("initialAtrStopMultiple", "Initial ATR Stop Multiple", "Midpoint ATR multiple used by the swing stop candidate.", "2.75", "0.10", "10.00"),
            bool("atrPercentileStopScaling", "ATR Percentile Stop Scaling", "Scale the swing ATR stop multiple between configured bounds using recent ATR percentile.", true),
            integer("atrStopPercentileLookbackBars", "ATR Stop Percentile Lookback", "Primary bars used to percentile-rank current ATR for swing stop scaling.", 60, 5, 500),
            decimal("minAtrStopMultiple", "Minimum ATR Stop Multiple", "Lower bound for ATR-percentile swing stop scaling.", "2.50", "0.10", "10.00"),
            decimal("maxAtrStopMultiple", "Maximum ATR Stop Multiple", "Upper bound for ATR-percentile swing stop scaling.", "3.00", "0.10", "10.00"),
            ...
            integer("maxHoldingBars", "Max Holding Bars", "Hard swing holding cap in primary bars.", 96, 1, 1000),
            ...
            decimal("maxEntryAtrFromCloudTop", "Max Entry ATR From Cloud", "Normal anti-chase distance from cloud boundary. Zero disables this guard.", "0.00", "0.00", "50.00"),
            decimal("maxEntryAtrFromCloudTopStrongVolume", "Strong-Volume Max Entry ATR", "Anti-chase distance allowed when volume and MACD are strong. Zero disables this guard.", "0.00", "0.00", "50.00"),
